...
<div class = 'graph-row'>
    ...
    <table class = 'graph'>
        <tr>
            <td>
                <img class = 'graph day' src = '{{config.graphite_url}}/render/?width=600&height=400&target=alias({{m}},"12 hours ago")&target=alias(dashed(timeShift({{m}},"7d")),"7 days ago")&title={{m}}&from=-12h' />
            </td>
            <td>
